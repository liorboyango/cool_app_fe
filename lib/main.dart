              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(labelText: 'LinkedIn URL', prefixIcon: Icon(Icons.business), hintText: 'https://linkedin.com/in/username'),
                  ),
                  const SizedBox(height: 8),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return UserCard(
          ...
          facebookUrl: null, // Assuming no facebook for now
